...
def check_price():
    ...
    if cpolarity == 1:
        trig_point = float(
            input(
                "Input the trigger price(dollar) above at which you want to recieve mail alert: "
            )
        )
    else:
        trig_point = float(
            input(
                "Input the trigger price(dollar) below at which you want to recieve mail alert: "
            )
        )
