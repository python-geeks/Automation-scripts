...
def main():
    ...
    parser.add_argument(
        "-x", "--ignore", help="A list of keys to ignore in a json file"
    )
    parser.add_argument(
        "-k", "--keep", help="A list of keys to convert exclusively in a json file"
    )
    parser.add_argument(
        "-r", "--replace", help="A list of dict to replace keys values. Not implemented"
    )
