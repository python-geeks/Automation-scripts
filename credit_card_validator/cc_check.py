        ...
        try:
            ...
            if (
                ...
                if card_number[0:1] == "4" and (lenn == 16 or lenn == 13):  # visa case
                    ...
                    card_number[0:2] == "34" or card_number[0:2] == "37" and lenn == 15
                ):  # american express card
                    print("Type:", cc[1])
                    print("Major Industry Identifier (MII):", mii[digi[0]])
                    ...
                    card_number[0:2] == "300"
                    or card_number[0:2] == "301"
                    or card_number[0:2] == "302"
                    or card_number[0:2] == "303"
                    or card_number[0:2] == "304"
                    or card_number[0:2] == "305"
                    and lenn == 14
                    ...
                    card_number[0:2] == "51"
                    or card_number[0:2] == "52"
                    or card_number[0:2] == "53"
                    or card_number[0:2] == "54"
                    ...
                    print(
                        "Other informations are not displayed as it doesn't belong to list shown below, however cc is valid"
                    )
                    for i in cc:
                        print(">", i)
            else:
