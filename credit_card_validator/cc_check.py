		...
		try:
			...
			if is_valid(card_number) and 13 <= len(card_number) and len(card_number) <= 19:
				...
				if card_number[0:1] == "4" and ( lenn == 16 or lenn == 13 ): # visa case
					...
					if(lenn==13):
						print("CardAccount Number:", card_number[7:13])
						print("Checksum:", digi[12])
					else: # 16 case
						print("Card Account Number:", card_number[7:16])
						print("Checksum:", digi[15])

				elif card_number[0:2] == "34" or card_number[0:2] == "37" and lenn == 15 : # american express card
					print("Type:" , cc[1])
					print("Major Industry Identifier (MII):", mii[digi[0]])
					print("Card Account Number:", card_number[6:14])
					print("Checksum:", digi[14])


				elif card_number[0:2] == "36" or card_number[0:2] == "30" or card_number[0:2] == "38" and lenn ==14 : #Diner club ..
					print("Type:", cc[2])
					print("Major Industry Identifier (MII):", mii[digi[0]])
					print("Card Account Number:", card_number[5:13])
					...
					print("Type:", cc[3])
					print("Major Industry Identifier (MII):", mii[digi[0]])
					print("Card Account Number:", card_number[7:15])
					print("Checksum:", digi[15])
