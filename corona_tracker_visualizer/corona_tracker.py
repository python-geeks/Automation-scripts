...
def get_chart(country):
    ...
    try:
        ...
        canvas.get_tk_widget().grid(
            row=4, column=0, columnspan=3, sticky="wen", padx=20, pady=5
        )
        plt.show()
...
def main_ui():
    ...
    frame_stat.grid(
        row=0, column=1, sticky="ens", ipady=screen_height, ipadx=screen_width
    )

    visit_btn1 = tk.Button(
        frame_stat,
        text="Visit developer's site",
        bg="#fcaccd",
        font=("Helvetica", 11, "bold"),
        relief="flat",
        fg="#000000",
        command=lambda: call_browser(2),
    )
    visit_btn1.grid(
        row=0, column=0, ipady=3, ipadx=5, pady=(60, 5), padx=(20, 5), sticky="w"
    )

    visit_btn2 = tk.Button(
        frame_stat,
        text="Visit WHO's official site",
        bg="#fcaccd",
        font=("Helvetica", 11, "bold"),
        fg="#000000",
        relief="flat",
        command=lambda: call_browser(1),
    )
    visit_btn2.grid(row=0, column=1, ipady=3, ipadx=5, pady=(60, 5), padx=5, sticky="w")

    show_label = tk.Label(
        frame_stat,
        text="Enter Country name to show the growth Trend",
    ...
    name = tk.StringVar()
    entry = tk.Entry(
        frame_stat, width=15, textvariable=name, font=("Helvetica", 12, "bold")
    )
