...
class AutoMeet:
    ...
    def automeetG(self):
        ...
        try:
            ...
            try:
                self.browser.find_element_by_xpath(
                    "//span[@class='NPEfkd RveJvd snByac' and contains(text(), \
                                                    'Ask to join')]"
                ).click()
        ...
        self.waiting_N_click(
            '//*[@id="ow3"]/div[1]/div/div[4]/div[3]/div[6]/div[3]/div/div[2]/div[3]/span/span'
        )
        currentStudents = 0
        greatestStudents = 0
        text_temp = ""
        ...
        while True:
            ...
            text = self.browser.find_element_by_xpath(
                "/html/body/div[1]/c-wiz/div[1]/div/div[4]/div[3]/div[3]/ \
                                                      div/div[2]/div[2]/div[2]/span[2]/div/div[1]"
            ).text
            people = self.browser.find_element_by_xpath(
                "/html/body/div[1]/c-wiz/div[1]/div/div[4]/div[3]/div[3]/ \
                                                      div/div[2]/div[2]/div[1]/div[1]"
            ).text
            # print(people)
            # print(text)
            ...
            if "http" in final_text:
                notify = Notify()
                notify.send(
                    link[0][0] + "://" + link[0][1], link[0][0] + "://" + link[0][1]
                )
