...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--level",
        type=int,
        help="the saturation percentage to use (default: 0, max: 300)",
    )
    parser.add_argument(
        "-y", "--yes", action="store_true", help="skip the prompt to overwrite the file"
    )
    ...
    cmd = cmd.format(args.in_file, level, "-y " if args.yes else "", args.out_file)
    os.system(cmd)
