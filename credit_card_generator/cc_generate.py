...
def fill_cc(ll, t_rn):
    ...
    if is_valid(res):
        ...
        print(
            "!ERRORRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR"
        )
...
def cc_generator():
    ...
    ccn = int(
        input(
            "Choose the credit card number from the above list: [NOTE: Press -1 if you to generate random cc]::"
        )
    )

    if ccn == -1:
        print(
            "Choose the total numbers of random credit cards you want to generate:",
            end="",
        )
        cca = int(input())
        print(
            "*************************** List of randomly generated credit card numbers/name are shown below ******************************"
        )
        ccn_r = [1, 2, 3, 4, 5]
        ...
        if not (1 <= ccn <= 5):
            ...
            return
        print(
            "Choose the total numbers of credit cards you want to generate for ",
            cc[ccn - 1],
            ":",
            sep="",
            end="",
