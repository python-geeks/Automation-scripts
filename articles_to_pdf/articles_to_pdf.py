...
def setup_driver():
    ...
    if find_geckodriver.exists():
        ...
        browser = webdriver.Firefox(
            executable_path=PATH_TO_DRIVER, options=firefox_options, firefox_profile=opt
        )
        ...
        print(
            "ERROR: No valid driver found. Only geckodriver or chromedriver is supported!"
        )
        exit()
...
def process_option_1():
    ...
    # get user settings
    user_input = input(
        'Enter search term followed by number of articles between 1 and 10 (e.g "learn python 5"): '
    )
