import os
from tkinter import (BOTH, END, SUNKEN, Button, Entry, Frame, Label, Text, Tk,
                     X, font)
...
class AlHtmlToMarkdown:
    def __init__(self):
            ...
            if os.path.exists(filepath):
                ...
                try:
                    if extension.lower() == ".html":
                        ...
                        markdownFilePath = os.path.join(
                            cwd + "\\AlHtmlToMarkd" "own\\Markdown", markdownFileName
                        )
                        ...
                        text.insert(
                            1.0,
                            markdownFileName + " has been saved "
                    ...
                    print(str(e))
                    text.insert(
                        1.0, "Invalid document, please provide .html " "extension files"
                    )
            else:
                text.delete(1.0, END)
        ...
        appHighlightFont = font.Font(
            family="OnePlus Sans Display", size=12, weight="bold"
        )
        ...
        convertToMarkdown = Button(
            root, borderwidth=0, highlightthickness=3, text="MARKDOWN", command=markdown
        )
