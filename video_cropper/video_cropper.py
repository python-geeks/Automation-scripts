...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-t", "--top", type=str, help="the amount to crop off the top of the video"
    )
    parser.add_argument(
        "-b",
        "--bottom",
    ...
    parser.add_argument(
        "-l", "--left", type=str, help="the amount to crop off the left of the video"
    )
    parser.add_argument(
        "-r", "--right", type=str, help="the amount to crop off the right of the video"
    )
    parser.add_argument(
        "-o",
        "--output",
