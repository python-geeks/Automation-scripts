...
def jpg_to_png():
	...
	if import_filename.endswith(".jpg"):
		...
		messagebox.showinfo("Congratulations ", "Your image is converted to Png ")
	else:
...
def png_to_jpg():
	...
	if import_filename.endswith(".png"):
		...
		messagebox.showinfo("Congratulations ", "Your Image is converted to jpg ")
	else:
		Label_2 = Label(root, text="Error!", width=20, fg="red", font=("bold", 15))
		Label_2.place(x=80, y=280)
...
btn1 = Button(root, text="Click for JPG to PNG Conversion", width=30, height=2, bg="#22577A",
				fg="white", font=("arial", 12, "bold"), command=jpg_to_png)

#coordinates of first button on output window
btn1.place(x=100, y=120)

#second button for output window
btn2 = Button(root, text="Click for PNG to JPG Coversion", width=30, height=2, bg="#38A3A5",
				fg="white", font=("arial", 12, "bold"), command=png_to_jpg)
