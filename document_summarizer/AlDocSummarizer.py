...
class AlDocSummarizer:
    def __init__(self):
            ...
            if os.path.exists(filepath):
                ...
                try:
                    ...
                    summarySentences = heapq.nlargest(
                        int(lines.get()), sentenceScores, key=sentenceScores.get
                    )
                    ...
                    summaryFilePath = os.path.join(
                        cwd + "\\AlDocSummarizer\\" "Summarize", summaryFileName
                    )
                    ...
                    text.insert(
                        1.0,
                        summaryFileName + " has been saved "
                    ...
                    text.insert(
                        1.0,
                        "Invalid document, please provide .pdf or"
        ...
        lines = Label(
            root, text="NUMBER OF LINES IN WHICH DOCUMENT HAS TO" " SUMMARIZED"
        )
        lines.pack()
