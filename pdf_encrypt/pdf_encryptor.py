...
def parse_args():
    ...
    parser.add_argument('-e', '--encrypt', dest='encrypt', type=str, nargs=1, metavar='filename', help='Encrypt')
    parser.add_argument('-d', '--decrypt', dest='decrypt', type=str, nargs=1, metavar='filename', help='Decrypt')
...
if __name__ == '__main__':
    ...
    if args.encrypt:
        ...
        password = getpass.getpass("Please provide the password to encrypt the file with: ")
        ...
        password = getpass.getpass("Please provide the password to decrypt the file with: ")
