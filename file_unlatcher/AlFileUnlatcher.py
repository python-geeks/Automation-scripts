...
class AlFileUnlatcher:
    def __init__(self):
            ...
            if len(filesList) == 0:
                ...
                for file in filesList:
                    ...
                    try:
                        ...
                        print(str(e))
                        text.insert(
                            1.0, "Set a default application to open" " the input file"
                        )
        ...
        find = Button(
            root, borderwidth=0, highlightthickness=3, text="OPEN FILE", command=find
        )
