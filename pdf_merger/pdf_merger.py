...
print("✏️  Step 2: name your files in the order you want to merge! (like 'file1.pdf', 'file2.pdf'...)")

path = os.path.abspath(input("📬 Step 3: Type the path of the folder containing the PDFs you want to merge (relative path): "))
os.chdir(path)
