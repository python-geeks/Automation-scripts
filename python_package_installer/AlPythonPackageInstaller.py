...
class AlPythonPackageInstaller:
    def __init__(self):
        ...
        root.resizable(0, 0)
        root.iconbitmap(
            os.path.join(cwd + "\\UI\\icons", "alpythonpackageinstaller.ico")
        )
        ...
        install = Button(
            root, borderwidth=0, highlightthickness=3, text="INSTALL", command=install
        )
