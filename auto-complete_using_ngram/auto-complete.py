...
if __name__ == "__main__":
    ...
    d_sents = ["Yes, sir. We have oftentimes the honour to", "You know that your parents had a great",
            "London is a place where I'd love to", "A large cask of wine has been dropped"]
    ...
    if option == "1":
        ...
        input_text = input("Please enter an 8 word sentence (Since loaded model uses 8-gram): ")

    n_seq = int(input("Enter number of more words to generate: "))

    if len(input_text.split()) < 8:
        raise("Please enter an 8 word sentence to start with or choose from defaults!!!")
