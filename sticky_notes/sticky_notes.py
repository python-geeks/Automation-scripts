...
# Welcome Message
start_msg = Label(notes_frame, text="Enter a note to get started...", font=("Sans serif", 18), fg="darkgrey")
...
unchecked_button = Button(function_button_frame, text="Uncheck item", command=uncheck_note)
